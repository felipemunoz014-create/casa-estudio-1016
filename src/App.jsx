...
export default function App() {
  ...
  const logout = () => {
    sessionStorage.removeItem("ce1016_admin");
    setIsAdmin(false);
    setEditMode(false);
  };
  ...
  const DEFAULT_CONTENT = {
    ...
    heroTitle1: "Revestimientos",
    heroTitle2: "de alto estándar",
    heroTitle3: "para tu espacio",
    heroSubtitle: "Arquitectura, diseño e importación de materiales decorativos. Santa Bárbara — atendemos todo Chile.",
    heroBtnPrimary: "Ver Catálogo",
    heroBtnSecondary: "Cotizar",
    heroImage: heroImg,
    stat1n: "14+",
    stat1l: "Productos",
    stat2n: "Alta densidad",
    stat2l: "Materiales",
    stat3n: "Inauguración",
    stat3l: "Precios 2026",
    stat4n: "Santa Bárbara",
    stat4l: "Todo Chile",
    aboutTag: "Quiénes somos",
    aboutTitle1: "Arquitectura",
    aboutTitle2: "& Diseño",
    ...
    svc1icon: "🏛️",
    svc1title: "Arquitectura & Diseño",
    svc1desc: "Asesoría profesional para proyectos residenciales y comerciales.",
    svc2icon: "📦",
    svc2title: "Importación Directa",
    svc2desc: "Materiales de alta calidad desde el fabricante, sin intermediarios.",
    svc3icon: "🛠️",
    svc3title: "Asesoría Técnica",
    svc3desc: "Te guiamos en la elección correcta según el ambiente y presupuesto.",
    svc4icon: "🚚",
    svc4title: "Despacho Nacional",
    svc4desc: "Enviamos a cualquier región del país.",
    ctaTitle1: "¿Cómo quedaría en",
    ctaTitle2: "tu espacio?",
    ...
    contactAddr: "Arturo Prat 1016, Santa Bárbara",
    contactPhone: "+56 9 7868 2990",
    contactPay: "VISA · Redcompra · MercadoPago",
    contactWaBtn: "💬 Abrir WhatsApp",
      ...
      <section id="catalogo" style={{ padding: `${sm ? 52 : 80}px ${sm ? 16 : 32}px`, background: C.bg }}>
        <div style={{ maxWidth: 1400, width: "100%", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", gap: 8, marginBottom: 28, overflowX: "auto", paddingBottom: 4, scrollbarWidth: "none" }}>
            {CATS.map((c) => (
              <button key={c} onClick={() => setFilterCat(c)} style={{ flexShrink: 0, padding: "8px 18px", border: `1.5px solid ${filterCat === c ? C.warm : "#E8E0D4"}`, borderRadius: 30, fontSize: 12, fontWeight: 600, cursor: "pointer", background: filterCat === c ? C.warm : "white", color: filterCat === c ? "white" : C.mid, fontFamily: "inherit", transition: "all .15s" }}>{CAT_L[c]}</button>
            ))}
          </div>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: sm ? "1fr" : "46% 54%", minHeight: sm ? "auto" : 320 }} onClick={() => !editMode && setExpanded(expanded === p.id ? null : p.id)}>
                    ...
                    <div style={{ padding: sm ? "18px 18px 20px" : "26px 24px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
                        <div style={{ background: "#2F6E6C", color: "white", padding: sm ? "10px 14px" : "12px 16px", borderRadius: 10, fontSize: sm ? 15 : 17, fontWeight: 800, lineHeight: 1 }}>
                          {$$(p.price)} <span style={{ fontSize: 12, fontWeight: 500, opacity: 0.9 }}>{p.unit}</span>
                        </div>
