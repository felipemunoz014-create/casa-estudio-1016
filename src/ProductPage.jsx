      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px 80px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 20 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{ background: "#FFF8F2", borderRadius: 14, padding: "20px", border: "1px solid #F0D8C0" }}>
              <h3 style={{ fontFamily: "'HWYGWide', sans-serif", fontSize: 14, fontWeight: 700, color: "#8B5E2A", marginBottom: 10, display: "flex", gap: 6 }}><span>🛡️</span> Garantía</h3>
              <p style={{ fontSize: 12, color: "#8B5E2A", lineHeight: 1.75 }}>{p.garantia}</p>
            </div>
